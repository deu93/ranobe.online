...
<div  class="middle_column">
    <div class="content_left">
        <img src="image.jpg" alt="" class="content_left_img">
        ...
        <div class="content_right_bot">
            ...
            <div class="content_right_description">
                <div id="description" class="tabcontent">
                    <p>Юань родился с неизлечимой болезнью, которая сделала его слепым в молодом возрасте и несколько лет спустя калекой. Признанный безнадёжным больным, его родители отказались от него, и мир забыл о его существовании.

                    В тёмном и затхлом мире его младшая сестра стала единственной причиной его жизни.

                    Следите за тем, как этот молодой человек достигает вершины как гений в «Культивация Онлайн», новейшей VRMMORPG, становясь легендарной фигурой в обоих мирах.</p>
                  </div>

                  <div id="about" class="tabcontent">
                    <p class="about">Статус произведения: В процессе выхода</p>
                    
                   <p class="about">Статус перевода: Активен</p> 
                        
                    <p class="about">Количество глав: более 500</p>
                  </div>
