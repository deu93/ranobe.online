    ...
    <div id="content" class="view_change_style standart">
        <div class="middle_column_content">
            <div class="left_content">
                <img class="left_content_img" src="{{ asset('img/image.webp') }}" alt="">
                <a class="left_content_link" href="">Читать</a>
            </div>
            <div class="right_content">
                <a href="#">
                    <h2>Культивация Онлайн</h2>
                </a>
        ...
        <div class="middle_column_content">
            <div class="left_content">
                <img class="left_content_img" src="{{ asset('img/image (1).webp') }}" alt="">
                <a class="left_content_link" href="">Читать</a>
            </div>
            <div class="right_content">
                <a href="#">
                    <h2>Повелитель Драконьей Крови</h2>
                </a>
                <div class="last_chapter">
                    <a href="#">
                        <h4>
